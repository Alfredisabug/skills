...
- **GitHub API Manager**：當使用者要求操作 GitHub API (Issues、Pull Requests、Actions 等) 時使用。自動偵測 GitHub 相關請求或手動觸發。請載入並遵循 [`skills/productivity/github-api-manager/SKILL.md`](skills/productivity/github-api-manager/SKILL.md)。
- **Git 資產與附件管理 (Git Asset Manager)**：當使用者要求上傳、管理或附加檔案至 GitHub/GitLab (Release Assets、Issue/PR/MR 附件等) 時使用。請載入並遵循 [`skills/productivity/git-asset-manager/SKILL.md`](skills/productivity/git-asset-manager/SKILL.md)。
...
- **產品需求與流程規劃 (Product Grill Me)**：當使用者在規劃產品需求、釐清非程式碼的工作流，或是撰寫新 Skill 時，請載入並遵循 [`skills/productivity/grillme/SKILL.md`](skills/productivity/grillme/SKILL.md)。
