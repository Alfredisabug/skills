...
- **Asset Manager**：當使用者要求上傳、管理或刪除檔案附件時使用（支援 GitLab/GitHub）。與 API Manager 協作處理資源關聯。請載入並遵循 [`skills/productivity/asset-manager/SKILL.md`](skills/productivity/asset-manager/SKILL.md)。
